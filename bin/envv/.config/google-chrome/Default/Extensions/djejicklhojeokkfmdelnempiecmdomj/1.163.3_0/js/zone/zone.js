...
var Zone$1 = (function(global) {
    ...
    var Zone = (function() {
        ...
        Zone.prototype.scheduleMacroTask = function(source, callback, data, customSchedule, customCancel) {
            return this._zoneDelegate.scheduleTask(
                this, new ZoneTask('macroTask', this, source, callback, data, customSchedule, customCancel)
            );
        };
        Zone.prototype.scheduleEventTask = function(source, callback, data, customSchedule, customCancel) {
            return this._zoneDelegate.scheduleTask(
                this, new ZoneTask('eventTask', this, source, callback, data, customSchedule, customCancel)
            );
        };
        ...
        if (promise[symbolState] === UNRESOLVED) {
            if (value instanceof ZoneAwarePromise && value[symbolState] !== UNRESOLVED) {
                ...
                if (typeof value.then !== 'function') {
                    throw new Error(
                        'A value appears to be thenable but .then is not a function. This is the value: ' +
                ...
                if (queue.length == 0 && state == REJECTED) {
                    ...
                    try {
                        throw new Error(
                            'Uncaught (in promise): ' + value + (value && value.stack ? '\n' + value.stack : '')
                        );
                    } catch (e) {
                        var error_1 = e;
...
function makeZoneAwareAddListener(addFnName, removeFnName, useCapturingParam, allowDuplicates) {
    ...
    return function zoneAwareAddListener(self, args) {
        ...
        var data =
            {target: target, eventName: eventName, name: eventName, useCapturing: useCapturing, handler: handler};
    ...
    try {
        ...
        if (desc.configurable) {
            ...
            try {
                ...
                console.log(
                    'Attempting to configure \'' + prop + '\' with descriptor \'' + descJson + '\' on object \'' + obj +
                    '\' and got error, giving up: ' + e
                );
            }
        } else {
            throw e;
